        ...
        for (var i = 0; i < NoAtomos; i++) {
            ...
            if (molecule.LstAtoms[apuntador].NameAtom == 'H') {
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayH[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayH[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayH[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayC_PB_TI_CA[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayC_PB_TI_CA[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayC_PB_TI_CA[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayN[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayN[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayN[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayO[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayO[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayO[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayS[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayS[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayS[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayP[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayP[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayP[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var z = 0; z < verArray.length;) {
                    ...
                    ///////////////////////// COLORES DIFFUSOS /////////////////////////////////////////
                    vertexPositionDataD[0].push(verArrayDefault[z] + molecule.LstAtoms[apuntador].X - Cx);
                    vertexPositionDataD[0].push(verArrayDefault[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                    vertexPositionDataD[0].push(verArrayDefault[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                ...
                for (var j = 0; j < Restantes; j++) {
                    ...
                    if (molecule.LstAtoms[apuntador].NameAtom == 'H') {
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayH[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayH[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayH[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                        ...
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayC_PB_TI_CA[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayC_PB_TI_CA[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayC_PB_TI_CA[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                        ...
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayN[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayN[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayN[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                        ...
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayO[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayO[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayO[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                        ...
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayS[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayS[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayS[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                        ...
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayP[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayP[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayP[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
                        ...
                        for (var z = 0; z < verArray.length;) {
                            ...
                            vertexPositionDataD[i].push(verArrayDefault[z] + molecule.LstAtoms[apuntador].X - Cx);
                            vertexPositionDataD[i].push(verArrayDefault[z + 1] + molecule.LstAtoms[apuntador].Y - Cy);
                            vertexPositionDataD[i].push(verArrayDefault[z + 2] + molecule.LstAtoms[apuntador].Z - Cz);
