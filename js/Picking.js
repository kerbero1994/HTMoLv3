                ...
                if (atom.State == 'Active') 
                {
                    ...
                    if (event.ctrlKey) 
                    {
                        ...
                        if (atom.Seleccionado == true) 
                        {
                            ...
                            //////////--------------el atomo seleccionado no es el último en los Bloques Wire-----------------//////////
                                ...
                                if (LstBW[NBW - 1].length == 0) {
                                    ...
                                    if (atom.BloqueWire != NBS) {
                                        ...
                                        gl.bindBuffer(gl.ARRAY_BUFFER, ChainBufferW[atom.BloqueWire - 1]);
                                        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(ChainIndexW[atom.BloqueWire - 1]), gl.DYNAMIC_DRAW);
                                        ChainBufferW[atom.BloqueWire - 1].itemSize = 2;
                                        ChainBufferW[atom.BloqueWire - 1].numItems = (ChainIndexW[atom.BloqueWire - 1].length / 2) * 1;
                            ...
                            ChainBuffer[NBS - 1].numItems = ChainIndex[NBS - 1].length/2;
